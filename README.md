...
> This is an API only setup using Ruby on rails as the back end. and have [hello-react-front-end](https://github.com/jecode93/hello-react-front-end) as the front end.
